...
class ExperimentAutoencoder(Experiment):
    ...
    def eval(self) -> dict[str, float]:
        ...
        encoder = tf.keras.Model(autoencoder.get_layer("image_input").output, autoencoder.get_layer("bottleneck").output)

        # Prev line modified: autoencoder.get_layer("input_image").output
        # Load data.
...
if __name__ == "__main__":
    ...
    # from experiments.e00_autoencoder_f.config.config import ConfigExp
    from config.config import ConfigExp
