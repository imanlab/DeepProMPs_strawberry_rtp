...
class ConfigExp(Config):
    ...
    def __init__(self, model_name: str = None) -> None:
        ...
        self.EXP_DIR = "experiments/e_00_autoencoder_f"

        # Data.
        self.DATA_DIR = "/home/francesco/PycharmProjects/dataset/dataset_autoencoder/"
        self.IMAGE_DIR = os.path.join(self.DATA_DIR, "strawberry_bb/")
