...
J_DIR = os.path.dirname(os.path.abspath(inspect.getfile(inspect.currentframe())))   # Directory del folder
ROOT_DIR = os.path.dirname(os.path.dirname(os.path.dirname(J_DIR)))

'''Data.'''

'''RGB-D images folder. '''
IMAGE_PATH = os.path.join(ROOT_DIR, "dataset/dataset_autoencoder/strawberry_renamed/")


''' Annotations folder. '''
ANNOTATION_PATH = os.path.join(ROOT_DIR, "dataset/dataset_autoencoder/probabilistic_joints_renamed/")
