...
if __name__ == "__main__":
    ...
    # Load the MLP model
    loss = RMSE(promp)
    load_model_name = "model_17_02__14_37"
    ...
    # Load the data
    input_img = "/home/francesco/PycharmProjects/deep_movement_primitives-main/images/proper_robot_test_4.png"
    ...
    for dof in range(7):
        ...
        # pdfs.append(pdf)
        traj_pdf = tfp.distributions.Sample(pdf)
        traj_sample = traj_pdf.sample()
    ...
    np.save("/home/francesco/PycharmProjects/deep_movement_primitives-main/predictions/model_17_02__14_37/"
            "proper_robot_test4.npy", traj_dofs)
