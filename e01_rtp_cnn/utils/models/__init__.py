...
def get_convolutional_model(output_size_mean: int,output_size_pca: int, activation: str = "relu", l1_reg: float = 0.0, l2_reg: float = 0.0, name: str = "Deep_ProMPs_model_RGB") -> Model:
    ...
    output_mean = fully_connected_block(x, [64], output_size_mean, activation=activation, output_activation="linear", l1_reg=l1_reg, l2_reg=l2_reg)
    output_pca = fully_connected_block(x, [64], output_size_pca, activation=activation, output_activation="linear", l1_reg=l1_reg, l2_reg=l2_reg)
    output_layer = layers.Concatenate(axis=1)([output_mean, output_pca])
